...
<reference>
@/Users/chengtong/OpenSource/myagent/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/chengtong/OpenSource/myagent/.claude/get-shit-done/references/user-profiling.md` to load:
