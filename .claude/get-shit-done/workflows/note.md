...
- **Global scope**: `/Users/chengtong/OpenSource/myagent/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/chengtong/OpenSource/myagent/.claude/notes/`)
...
2. Glob `/Users/chengtong/OpenSource/myagent/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/chengtong/OpenSource/myagent/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/chengtong/OpenSource/myagent/.claude/notes/` — works in any directory
