...
**Domain:** Agent platform for testing tool/skill/MCP/context flows (FastAPI streaming + resumable sessions)
...
```bash
# Core
uv add fastapi==0.135.3 uvicorn==0.44.0 agentscope-runtime==1.1.3 modelcontextprotocol==1.27.0 redis==7.4.0 pydantic==2.12.5 pydantic-settings==2.13.1

# Supporting
uv add orjson sse-starlette
...
**If you need fully local/offline validation:**
...
**If you want realistic resume semantics:**
...
---
*Stack research for: agent testing platform shell*